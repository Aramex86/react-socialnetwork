        ...
        <div>
            <div className='userinfo__description'>
                <div className='userinfo__description-avatar'>
                    <div> {props.profile.photos.small != null? <img src={props.profile.photos.small}  alt="avatar"/>:<img src={userPhoto} alt="avata" className='userphoto'/>} </div>
                </div>
                <div className='userinfo__description-userinfo'>
                    ...
                    <div className='userinfo__description-about'>
                       <div className="userinfo__description-about-joblook">
                            ...
                            <span>{props.profile.lookingForAJob? <img src={like} alt="like" className="like"/>:<img src={unlike} alt="unlike" className="unlike"/>}</span>
                        </div>
